...
class UpdateEventRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Category & Type
            'category' => 'sometimes|string|in:concert,theater,sport,party,conference,exhibition,workshop,other',
            ...
            // Capacity
            'total_capacity' => 'sometimes|integer|min:1|max:1000000',
            ...
            // Status (only owner can change)
            'status' => 'sometimes|string|in:draft,pending,published,cancelled,postponed',
            'is_featured' => 'sometimes|boolean',
            'is_published' => 'sometimes|boolean',
            'is_cancelled' => 'sometimes|boolean',
            'cancellation_reason' => 'nullable|required_if:is_cancelled,true|string|max:500',
